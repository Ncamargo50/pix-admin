...
ax.set_title('Serro Alto - Red de drenaje por ACUMULACION DE FLUJO (FABDEM 30m)\nazul=cauce principal >1.8km2 | naranja=drenaje fino >0.27km2'); setlim(ax)
...
ax.set_title('Serro Alto - PLANI-ALTIMETRIA (FABDEM): sombreado + curvas cada 5 m'); setlim(ax)
...
ax.set_title('Serro Alto - TWI (indice de humedad topografica) - alto=convergencia/humedo'); setlim(ax)
