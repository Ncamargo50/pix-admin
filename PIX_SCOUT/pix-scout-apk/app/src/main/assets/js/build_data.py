...
focos=[
 dict(id='F-2607-14',cultivo='trigo',lote='Talhão B14',hacienda='Cerro Alto',sev='muy_alta',score=94,area_ha=6.2,patron='foco',estadio='Floración',punto='3/8',resumen='clúster rojo en floración, avanza rápido',lat=-24.9871,lon=-49.8123),
 dict(id='F-2607-07',cultivo='soya',lote='Bloque 2-L07',hacienda='Cerro Alto',sev='alta',score=81,area_ha=11.4,patron='difuso',estadio='Vegetativo',punto='5/12',resumen='amarillamiento amplio en la loma seca',lat=-24.9910,lon=-49.8007),
